...
namespace Magic
{
	...
	public static class SMemory
	{
		...
		public static int ReadRawMemory(IntPtr hProcess, ulong dwAddress, IntPtr lpBuffer, int nSize)
		{
			int lpBytesRead = 0;
		...
		public static byte[] ReadBytes(IntPtr hProcess, ulong dwAddress, int nSize)
		{
		...
		/// <param name="bReverse">Determines whether bytes will be reversed before returning or not (big-endian or little-endian)</param>
		/// <returns>Returns memory read from external process.</returns>
		public static int ReadInt(IntPtr hProcess, ulong dwAddress, bool bReverse)
		{
		...
		/// <param name="bReverse">Determines whether bytes will be reversed before returning or not (big-endian or little-endian)</param>
		/// <returns>Returns memory read from external process.</returns>
		public static UInt64 ReadUInt64(IntPtr hProcess, ulong dwAddress, bool bReverse)
		{
